...
class FilePathRegexSettingDialog(
    currentOrigin: String = DEFAULT_ORIGIN,
    currentRelated: String = DEFAULT_RELATED,
    currentCategory: String = DEFAULT_CATEGORY
) : SettingDialog() {
    companion object {
        private val TITLE = I18n.lazyMessage("altn8.filePathRegex.add.dialog.title")
        private val ORIGIN_LABEL = I18n.lazyMessage("altn8.filePathRegex.add.dialog.origin.label")
        private val RELATED_LABEL = I18n.lazyMessage("altn8.filePathRegex.add.dialog.related.label")
        private val CATEGORY_LABEL = I18n.lazyMessage("altn8.filePathRegex.add.dialog.category.label")
        ...
        private val SHORT_FILE_PATH_REGEX_DIALOG_PURPOSE = I18n.lazyMessage("altn8.filePathRegex.add.dialog.purpose")
        private val FURTHER_INFORMATION_ABOUT_A_FILE_PATH_REGEX =
            I18n.lazyMessage("altn8.filePathRegex.add.dialog.furtherInformation")

        private val DEFAULT_ORIGIN = I18n.message("altn8.filePathRegex.add.default.origin")
        private val DEFAULT_RELATED = I18n.message("altn8.filePathRegex.add.default.related")
        private val DEFAULT_CATEGORY = I18n.message("altn8.filePathRegex.add.default.category")
    }

    override val headline = TITLE.get()
    override val shortPurpose = SHORT_FILE_PATH_REGEX_DIALOG_PURPOSE.get()
    override val furtherInformation = FURTHER_INFORMATION_ABOUT_A_FILE_PATH_REGEX.get()
